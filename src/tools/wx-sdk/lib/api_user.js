...
exports.jscode2session = async function(code) {
    ...
    const url = `https://api.weixin.qq.com/sns/component/jscode2session?appid=${this.appid}&js_code=${code}&grant_type=authorization_code&component_appid=${this.componentAppid}&component_access_token=${componentToken.componentAccessToken}`;
