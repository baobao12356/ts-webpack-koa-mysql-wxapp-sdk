 ...
 */
exports.fastRegisterWeappCreate = async function(
    name,
    code,
    codeType,
    legalPersonalWechat,
    ...
    const url =
        this.prefix +
        'component/fastregisterweapp?action=create&component_access_token=' +
...
exports.fastRegisterWeappSearch = async function(name, legalPersonalWechat, legalPersonalName) {
    ...
    const url =
        this.prefix +
        'component/fastregisterweapp?action=search&component_access_token=' +
        componentAccessToken.componentAccessToken;
    const data = {
        name: name,
        legal_persona_wechat: legalPersonalWechat,
