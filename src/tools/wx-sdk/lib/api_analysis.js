...
exports.dailySummaryTrend = async function(beginDate, endDate) {
    ...
    const url =
        this.datacubePrefix +
        'getweanalysisappiddailysummarytrend?access_token=' +
        token.accessToken;
    const data = {
...
exports.dailyVisitTrend = async function(beginDate, endDate) {
    const token = await this.ensureAccessToken();
    const url =
        this.datacubePrefix + 'getweanalysisappiddailyvisittrend?access_token=' + token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
    };
...
exports.weeklyVisitTrend = async function(beginDate, endDate) {
    ...
    const url =
        this.datacubePrefix +
        'getweanalysisappidweeklyvisittrend?access_token=' +
        token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
...
exports.visitDistribution = async function(beginDate, endDate) {
    ...
    const url =
        this.datacubePrefix +
        'getweanalysisappidvisitdistribution?access_token=' +
        token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
...
exports.dailyRetainInfo = async function(beginDate, endDate) {
    const token = await this.ensureAccessToken();
    const url =
        this.datacubePrefix + 'getweanalysisappiddailyretaininfo?access_token=' + token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
    };
...
exports.weeklyRetainInfo = async function(beginDate, endDate) {
    ...
    const url =
        this.datacubePrefix +
        'getweanalysisappidweeklyretaininfo?access_token=' +
        token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
...
exports.monthlyRetainInfo = async function(beginDate, endDate) {
    ...
    const url =
        this.datacubePrefix +
        'getweanalysisappidmonthlyretaininfo?access_token=' +
        token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
...
exports.visitPage = async function(beginDate, endDate) {
    const token = await this.ensureAccessToken();
    const url =
        this.datacubePrefix + 'getweanalysisappidvisitpage?access_token=' + token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
    };
...
exports.userPortrait = async function(beginDate, endDate) {
    const token = await this.ensureAccessToken();
    const url =
        this.datacubePrefix + 'getweanalysisappiduserportrait?access_token=' + token.accessToken;
    const data = {
        begin_date: beginDate,
        end_date: endDate
    };
