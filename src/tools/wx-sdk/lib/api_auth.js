...
exports.createPreAuthCode = async function() {
    ...
    const url =
        this.prefix +
        'component/api_create_preauthcode?component_access_token=' +
...
exports.queryAuth = async function(queryAuthCode) {
    ...
    const url =
        this.prefix +
        'component/api_query_auth?component_access_token=' +
        componentAccessToken.componentAccessToken;
    const data = {
        component_appid: this.component_appid,
...
exports.getAuthorizerInfo = async function() {
    ...
    const url =
        this.prefix +
        'component/api_get_authorizer_info?component_access_token=' +
        componentAccessToken.componentAccessToken;
    const data = {
        component_appid: this.component_appid,
...
exports.getAuthorizerOption = async function(optionName) {
    ...
    const url =
        this.prefix +
        'component/api_get_authorizer_option?component_access_token=' +
        componentAccessToken.componentAccessToken;
    const data = {
        component_appid: this.component_appid,
        authorizer_appid: this.appid,
